...
@Component({
  ...
  <button 
    type="button" 
    (click)="appStore.signWithGoogle()"
    class="w-full text-sm flex justify-center items-center gap-2 border border-gray-300 rounded-box p-2 not-first:hover:shadow-primary shadow duration-300 cursor-pointer"
